...
export interface BouquetAssociation extends Section {
    bouquet_id: number;
    bouquet_descriptors_length: number;
    bouquet_descriptors: TsDescriptors;
...
export default class TsSectionBouquetAssociation extends TsSectionBase {
    constructor(buffer, pid) {
        super(buffer, pid);
    }

    decode(): BouquetAssociation {
        const reader = new TsReader(this._buffer);
        const objSection = {} as any as BouquetAssociation;
