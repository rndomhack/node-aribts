...
export interface EventInformation extends Section {
    service_id: number;
...
export default class TsSectionEventInformation extends TsSectionBase {
    constructor(buffer, pid) {
        super(buffer, pid);
    }

    decode(): EventInformation {
        const reader = new TsReader(this._buffer);
        const objSection = {} as any as EventInformation;
