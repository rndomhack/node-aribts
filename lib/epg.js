            ...
            event.descriptors.forEach(descriptor => {
                switch (descriptor.descriptor_tag) {
                    ...
                    case 0xC4:
                        ...
                        audio_component.descriptor.dialog_control = epgTable.dialog_control[descriptor.component_type >> 7];
                        audio_component.descriptor.audio_for_handicapped = epgTable.audio_for_handicapped[(descriptor.component_type >> 5) & 0x03];
