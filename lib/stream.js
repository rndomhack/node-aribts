...
const TsPatParser = require("./table/pat");
const TsCatParser = require("./table/cat");
const TsPmtParser = require("./table/pmt");
const TsNitParser = require("./table/nit");
const TsBatParser = require("./table/bat");
const TsSdtParser = require("./table/sdt");
