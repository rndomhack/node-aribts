...
class TsTableSdt {
    ...
    decode() {
        ...
        while (reader.position < (objSdt.section_length << 3) + 24 - 32) {
            let service = {};
            ...
            service.descriptors = new TsDescriptors(this.buffer.slice(pos, pos + service.descriptors_loop_length)).decode();
