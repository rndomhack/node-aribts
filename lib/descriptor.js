...
class TsDescriptorParser {
    ...
    parse(buffer) {
        ...
        switch (objDescriptor.descriptor_tag) {
            ...
            case 0x58:
                ...
                while (reader.position >> 3 < 2 + objDescriptor.descriptor_length) {
                    ...
                    local_time_offset.time_of_change = reader.bslbf(40);
            ...
            case 0x67:
                ...
                while (reader.position >> 3 < 2 + objDescriptor.descriptor_length) {
                    ...
                    material_set.material_name = reader.char(material_set.material_name_length << 3);
                    material_set.material_code_type = reader.uimsbf(8);
                    material_set.material_code_length = reader.uimsbf(8);
                    material_set.material_code = reader.char(material_set.material_code_length << 3);
                    ...
                    material_set.material_url = reader.char(material_set.material_url_length << 3);
            ...
            case 0x68:
                ...
                if (objDescriptor.has_location) {
                    if (objDescriptor.location_type === 0) {
                        ...
                        objDescriptor.URL_byte = reader.char(objDescriptor.URL_length << 3);
                    }
                }
        ...
        // test
        /*if (objDescriptor.descriptor_tag === 0x50) {
