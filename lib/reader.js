...
const TsCharParser = require("./char");
const TsDateParser = require("./date");
...
class Reader {
    ...
    char(length) {
        ...
        var charParser = new TsCharParser(this.readBytes(length >> 3));

        return charParser.parse();
    }
    ...
    date(length) {
        ...
        var dateParser = new TsDateParser(this.readBytes(length >> 3));
